...
from app.schemas.speaker import SpeakerEnrollRequest, SpeakerProfileResponse, VoiceprintResponse
from app.core.exceptions import ResourceNotFoundError, TenantAccessViolation, AudioProcessingError
...
class SpeakerService:
    ...
    async def enroll_speaker(
        ...
        logger.info(f"Enrolled speaker {profile.id} ({display_name}) with {len(processed_samples)} samples ({total_duration:.1f}s)")
        return profile
